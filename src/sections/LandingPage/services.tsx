...
export default function ServicesSection() {
  return (
    <section
      id="services"
      className="py-8 sm:py-12 lg:py-16 bg-white overflow-hidden font-sans"
    >
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-semibold text-gray-900 leading-tight max-w-5xl mx-auto">
            Affordable Web Solutions for all types of Businesses - From Concept
            to Launch
          </h2>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8 flex flex-col items-center justify-between">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-6 leading-relaxed">
                Transform your business idea into a stunning, professional
                website. We build responsive, fast-loading websites that convert
                visitors into customers - perfect for startups and small
                businesses.
              </p>
            </div>
          ...
          <div className="space-y-8 lg:space-y-12">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8">
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-4 leading-relaxed">
                From website design to SEO optimization, mobile apps to
                e-commerce solutions - we provide end-to-end digital services
                that help small businesses compete with larger companies.
              </p>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8">
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-6 leading-relaxed">
                Your success is our priority. We provide ongoing website
                maintenance, updates, SEO optimization, and technical support to
                ensure your digital presence stays competitive and up-to-date.
              </p>
              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <div className="flex gap-4">
                  ...
                  >
                    <svg
                      className="w-6 h-6 text-gray-500 hover:text-pink-600 transition-colors"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                  ...
                  >
                    <svg
                      className="w-6 h-6 text-gray-500 hover:text-blue-800 transition-colors"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      xmlns="http://www.w3.org/2000/svg"
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8">
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                Add intelligent, ready-to-use website templates to your business
                that engage visitors instantly. From portfolio sites to
                e-commerce stores, these templates work 24/7 - so you never miss
                a customer, even when you&apos;re focused on your core business.
              </p>
            </div>
